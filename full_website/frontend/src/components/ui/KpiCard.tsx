...
export const KpiCard: React.FC<KpiCardProps> = ({ title, value, icon, trend, color = 'primary', className }) => {
    const colorStyles = {
    ...
    return (
        <Card className={cn("relative overflow-hidden hover:shadow-lg transition-shadow duration-300", className)}>
